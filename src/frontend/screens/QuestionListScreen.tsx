...
export default function ListScreen({
  ...
  return (
    <PageContainer>
      <div className="flex w-full items-center justify-center lg:py-6">
        {/* メインカードコンテナ */}
        <div className="w-full max-w-5xl rounded-2xl border border-slate-200 bg-white/80 shadow-sm backdrop-blur-xl overflow-hidden">
          {/* ヘッダーロゴエリア */}
